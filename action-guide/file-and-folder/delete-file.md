---
description: Delete file according to the File Path.
---
...
* File Path: The absolute path to the file that needs to be deleted on the computer (For example: `D:\data\temp_cookie.txt`).

...
During the script building process, GPM Automate automatically provides several system variables. You can call these variables in any action to retrieve information about the Profile or the Excel data being processed without having to initialize them yourself.

...
> 🔗 See detailed instructions on how to use in the example [1. Count the number of lines in a text file (Text)](../variables/count.md#vi-du-thuc-te-dem-so-luong-link-facebook-trong-file-d-2.txt) in the Coun&#x74;_)_.
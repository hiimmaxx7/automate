...
* Cách áp dụng: Sau khi sử dụng hành động Go to URL để truy cập vào trang chủ hoặc một bài viết chi tiết, bạn chèn hành động Random scroll xen kẽ với các lệnh Delay ngắn.
* Kết quả: Trình duyệt sẽ thực hiện lướt lên, lướt xuống, dừng lại xem, rồi lại cuộn tiếp một cách ngẫu hứng. Điều này giúp đánh lừa hoàn toàn các thuật toán quét hành vi, giúp Profile của bạn trông giống như một người dùng thật đang đọc tin tức, tăng tối đa độ trust cho tài khoản MMO.

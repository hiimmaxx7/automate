...
Create empty excel is an action used to initialize a completely new (`.xlsx` format) and empty Excel file at a specified path on your computer.

This action is often placed at the beginning of a script to prepare a clean storage file before data scraping (Data Crawler) or logging actions start pushing information into it.

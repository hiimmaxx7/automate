...
Get element data is the action of retrieving data (a specific attribute) of an element on the device screen by XPath, then saving it to a variable for use in subsequent steps.

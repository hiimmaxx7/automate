...
* XPath: The XPath of the element to retrieve data from, for example `//node[@resource-id="com.android.chrome:id/url_bar"]`. See how to get XPath at [Guide to Identify XPath & Coordinates](../phone-action/xpath-and-coordinates-guide.md).

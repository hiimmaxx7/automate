---
description: Pull (copy) a file from the phone device to the computer.
---

# Pull file

Pull file is the action of copying a file from the memory of the phone device to the computer (opposite of Push file), for example, retrieving a screenshot or result file from the phone.

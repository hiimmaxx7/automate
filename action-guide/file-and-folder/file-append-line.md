...
* If the file already exists: The system retains the old content, automatically moves to a new line at the end of the file, and appends the new line of data.

#### Configuration parameters:

* File Path: The absolute path to the `.txt` file you want to append data to (e.g., `D:\GPM\history_log.txt`).
* Text: The text content (or variable containing text) that you want to append to the end of the file.

...
* Timeout: The maximum time (measured in seconds depending on the interface settings) that the action will wait for a response from the server. If this time elapses without a response from the server, the action will automatically disconnect and report an error (or throw an exception) to avoid the script hanging indefinitely due to network lag or the opposing server being down.
...
**Example 1: With body `application/json`**

This is the most common format today when working with modern APIs. The body must be filled out according to the structure of curly braces `{}` and the data fields are enclosed in double quotes following the JSON standard.

<figure><img src="../../.gitbook/assets/image (163).png" alt=""><figcaption></figcaption></figure>

**Example 2: With body `application/x-www-form-urlencoded`**

This is the traditional string format often encountered in old login forms or some payment gateways. The property pairs are concatenated into a continuous text string.

<figure><img src="../../.gitbook/assets/image (164).png" alt=""><figcaption></figcaption></figure>

**Example 3: With body `multipart/form-data`**

...
Touch is the action of tapping on the screen of a mobile device. The tap point can be determined by the XPath of the element or by coordinates (x,y).

#### Explanation of configuration parameters:

* Touch type: How to determine the tap point:
...
* Coordinates (x,y): (when selecting Touch by coordinates) The tap point coordinates in the format `x,y`, for example `500,700`.

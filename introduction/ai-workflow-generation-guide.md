...
The Gen AI Workflow feature allows you to initiate a complete automation script simply by describing it in natural language. In simple terms, it's like AI browsing the web for you — the AI configured in GPM Automate will automatically read the content, analyze the requirements, combine with a real web browsing Agent to fully analyze the page structure, and retrieve accurate XPath as if a person were operating it before automatically generating the actions to push into the workflow.
...
To start the process of creating an automation script using AI, follow these steps:
...
* The Gen AI configuration window will appear with the following parameters:
  ...
  * **Mode:** 
    ...
    * **Live:** The Agent directly browses the web, reads the full page structure, and retrieves accurate XPath as a real person would.
...
* You can monitor the command blocks inserted into the GPM Automate interface and proceed to test the script for adjustments if necessary.
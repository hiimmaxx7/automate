...
When you open a secondary tab to get the verification code from an email or retrieve e-wallet information, after you have copied the desired data to a variable, you need to close that tab to free up RAM and keep the browser interface tidy:

...
* Bước 1: `Mouse press and hold` để ấn và giữ chặt vào thanh trượt captcha hoặc một phần tử giao diện.
* Bước 2: `Mouse move` để rê chuột kéo phần tử đó dịch chuyển đến vị trí đích.
* Bước 3: `Mouse release` để buông chuột, hoàn tất việc thả phần tử tại vị trí mới để hệ thống trang web ghi nhận kết quả.

...
* Nodes: The path (JSON Path) leading to the key containing the data to be retrieved.
...
* Nodes: Fill in as `data.[0].phone` _(where `data` goes into the data array, `[0]` is the position of the first person, and `phone` is the property to retrieve)_.

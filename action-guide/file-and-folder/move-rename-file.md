...
* Source File: The absolute path of the source file that needs to be moved or renamed (e.g., `D:\data\old_name.txt`).
* Destination File: The absolute path of the destination file where it will be moved to, or the path containing the new file name after renaming (e.g., `E:\backup\old_name.txt` or `D:\data\new_name.txt`).

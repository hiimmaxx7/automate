...
Import cookie is the action of loading a string or a structured cookie data file into the browser to automatically log the account into a successful login state without needing to fill in Username/Password.

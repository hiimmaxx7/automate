...
* XPath: The XPath of the input field to type into, for example `//node[@resource-id="com.android.chrome:id/url_bar"]`. See how to get XPath in [Guide to Identify XPath & Coordinates](./xpath-and-coordinates-guide.md).
...
* Max delay (ms): The maximum delay between characters (milliseconds), for example `200`. Each character will wait for a random period between min and max.
